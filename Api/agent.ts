...
axios.defaults.baseURL =  'http://194.147.58.56:8090/api/v1'  /* "https://api.talkative.az/api/v1" */;
...
export const baseImageUrl = `http://194.147.58.56:8090/api/v1/files/`; //https://api.talkative.az/api/v1/filesDownload/
